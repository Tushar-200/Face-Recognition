    ...
    dz.on("complete", function (file) {
        ...
        $.post(url, {
            ...
            data = [
                {
                    'class': 'dhoni', 
                    'class_probability': [81.74, 2.75, 2.44, 8.12, 4.95], 
                    'class_dictionary': {
                        'dhoni': 0, 
                        'lionel messi': 1,
                        'maria sharapova': 2,
                ...
                {
                    'class': 'dhoni',
                     'class_probability': [50.65, 7.3, 9.06, 7.62, 25.37], 
                     'class_dictionary': {
                        'dhoni': 0, 
                        'lionel messi': 1,
                         'maria sharapova': 2, 
            ...
            */
            ...
            let players = ["dhoni","lionel messi", "maria sharapova", "ronaldo",  "virat kohli"];
